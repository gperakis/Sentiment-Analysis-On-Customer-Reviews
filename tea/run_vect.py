...
if __name__ == "__main__":
    ...
    params = {
        # 'features__user_based_feat__extract__sentiment_positive__sent_positive__count_type': ['boolean', 'counts'], # user
        # 'features__user_based_feat__extract__sentiment_negative__sent_negative__count_type': ['boolean', 'counts'], # user
        ...
        # 'clf__n_estimators': (100, 300, 600) # Gradient Boosting
        'clf__max_depth': [10, 50, 100, None],  # Random Forest
        'clf__n_estimators': [200, 800, 1000],  # Random Forest
